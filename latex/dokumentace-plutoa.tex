...
V~následujících sekcích jsou popsány hlavní použité technologie.

\section{Backend technologie}

Backend je postaven na \textbf{Django 5.2} s~\textbf{Django REST Framework 3.16} pro API a \textbf{SimpleJWT 5.5} pro JWT autentizaci.

\section{Frontend technologie}

Frontend je postaven na \textbf{React 19} s~\textbf{TypeScriptem 4.9}. Pro vizualizace dat je použita knihovna \textbf{Recharts 3.4}, která poskytuje interaktivní grafy (BarChart, PieChart, AreaChart, LineChart). Komunikace s~API probíhá přes \textbf{Axios 1.13}.
...
\begin{figure}[H]
	\raggedright
	\includegraphics[width=0.6\textwidth]{image/registrace.png}
...
% TODO: Přidat obrázek health-score-detail.png
% Detail komponenty Financial Health Score - kruhový graf s číslem a breakdown komponent
\begin{figure}[H]
	\raggedright
	\includegraphics[width=0.6\textwidth]{image/health-score-detail.png}
...
% TODO: Přidat obrázek trend-analysis.png
% Screenshot analýzy trendů - kategorie s šipkami nahoru/dolů a procentuální změnou
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{image/trend-analysis.png}
...
% TODO: Přidat obrázek heatmap.png
% Screenshot heatmap kalendáře s barevnými buňkami zobrazujícími aktivitu
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{image/heatmap.png}
	\caption{Heatmap kalendář zobrazující denní finanční aktivitu}
	\label{fig:heatmap}
\end{figure}

% TODO: Přidat obrázek waterfall.png
% Screenshot waterfall chartu zobrazujícího cash flow
\begin{figure}[H]
	\centering
...
Aplikace podporuje CSV import a export transakcí pro zálohu dat a migraci z~jiných aplikací.
