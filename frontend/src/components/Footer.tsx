      ...
      <div className="footer-content">
        <div className="footer-section">
          ...
          <p className="footer-description">
            Váš osobní finanční plánovač. Mějte své finance pod kontrolou.
          </p>
        ...
        <div className="footer-section">
          ...
          <ul className="footer-links">
            ...
            <li><Link to="/overview">Přehled</Link></li>
            <li><Link to="/transactions">Transakce</Link></li>
            <li><Link to="/budgets">Rozpočty</Link></li>
            <li><Link to="/analytics">Analytika</Link></li>
          </ul>
        </div>

        <div className="footer-section">
          <h4 className="footer-heading">Účet</h4>
          <ul className="footer-links">
        ...
        <div className="footer-section">
          <h4 className="footer-heading">Podpora</h4>
          <ul className="footer-links">
